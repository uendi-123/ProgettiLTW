...
<html lang="en">
    ...
    <body class="bg-dark text-light">
        ...
        <div id="mainDiv" class="container">
            ...
            <!-- Box 3 Cose AJAX -->
            <div class="d-lg-grid d-sm-grid d-md-grid d-grid-container">
                <div id="offerteDiv" class="d-grid-item">
                    <span class="text-center fs-2 normalSpanCard activeSpanCard">Scopri i nostri prezzi!</span>
                </div>
                <div id="scegliDiv" class="d-grid-item">
                    <span class="text-center fs-2">Scegli Noi</span>
                </div>
                <div id="scontiDiv" class="d-grid-item">
                    <span class="text-center fs-2">Sconti </span>
                </div>
